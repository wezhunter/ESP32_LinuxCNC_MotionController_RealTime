/****************************************************************************************************************************
  AsyncUDP_ESP32_Ethernet_Impl.h
...
#ifndef ASYNC_UDP_ESP32_ETHERNET_IMPL_H
#define ASYNC_UDP_ESP32_ETHERNET_IMPL_H
...
inline AsyncUDPMessage::AsyncUDPMessage(size_t size)
{
  _index = 0;
...
inline AsyncUDPMessage::~AsyncUDPMessage()
{
  if (_buffer)
  {
    free(_buffer);
...
inline  size_t AsyncUDPMessage::write(const uint8_t *data, size_t len)
{
  if (_buffer == NULL)
  {
...
inline  size_t AsyncUDPMessage::write(uint8_t data)
{
  return write(&data, 1);
}
...
inline  size_t AsyncUDPMessage::space()
{
  if (_buffer == NULL)
  {
...
inline uint8_t * AsyncUDPMessage::data()
{
  return _buffer;
}
...
inline  size_t AsyncUDPMessage::length()
{
  return _index;
}
...
inline  void AsyncUDPMessage::flush()
{
  _index = 0;
}
...
inline AsyncUDPPacket::AsyncUDPPacket(AsyncUDPPacket &packet)
{
  _udp    = packet._udp;
  _pb     = packet._pb;
  _if     = packet._if;
...
inline AsyncUDPPacket::AsyncUDPPacket(AsyncUDP *udp, pbuf *pb, const ip_addr_t *raddr, uint16_t rport, struct netif * ntif)
{
  _udp    = udp;
  _pb     = pb;
...
inline AsyncUDPPacket::~AsyncUDPPacket()
{
  pbuf_free(_pb);
}
...
inline uint8_t * AsyncUDPPacket::data()
{
  return _data;
}
...
inline size_t AsyncUDPPacket::length()
{
  return _len;
}
...
inline int AsyncUDPPacket::available()
{
  return _len - _index;
}
...
inline size_t AsyncUDPPacket::read(uint8_t *data, size_t len)
{
  size_t i;
...
inline int AsyncUDPPacket::read()
{
  if (_index < _len)
  {
    return _data[_index++];
...
inline int AsyncUDPPacket::peek()
{
  if (_index < _len)
  {
    return _data[_index];
...
inline void AsyncUDPPacket::flush()
{
  _index = _len;
}
...
inline tcpip_adapter_if_t AsyncUDPPacket::interface()
{
  return _if;
}
...
inline IPAddress AsyncUDPPacket::localIP()
{
...
inline IPv6Address AsyncUDPPacket::localIPv6()
{
...
inline uint16_t AsyncUDPPacket::localPort()
{
  return _localPort;
}
...
inline IPAddress AsyncUDPPacket::remoteIP()
{
  if (_remoteIp.type != IPADDR_TYPE_V4)
  {
    return IPAddress();
...
inline IPv6Address AsyncUDPPacket::remoteIPv6()
{
...
inline uint16_t AsyncUDPPacket::remotePort()
{
  return _remotePort;
}
...
inline void AsyncUDPPacket::remoteMac(uint8_t * mac)
{
...
inline bool AsyncUDPPacket::isIPv6()
{
...
inline bool AsyncUDPPacket::isBroadcast()
{
  if (_localIp.type == IPADDR_TYPE_V6)
  {
    return false;
...
inline bool AsyncUDPPacket::isMulticast()
{
...
inline size_t AsyncUDPPacket::write(const uint8_t *data, size_t len)
{
  if (!data)
  {
...
inline size_t AsyncUDPPacket::write(uint8_t data)
{
  return write(&data, 1);
}
...
inline size_t AsyncUDPPacket::send(AsyncUDPMessage &message)
{
...
inline bool AsyncUDP::connect(const ip_addr_t *addr, uint16_t port)
{
  if (!_udp_task_start())
  {
...
inline bool AsyncUDP::listen(const ip_addr_t *addr, uint16_t port)
{
  if (!_udp_task_start())
  {
    log_e("failed to start task");
...
inline bool AsyncUDP::listenMulticast(const ip_addr_t *addr, uint16_t port, uint8_t ttl, tcpip_adapter_if_t tcpip_if)
{
...
inline size_t AsyncUDP::writeTo(const uint8_t * data, size_t len, const ip_addr_t * addr, uint16_t port,
...
inline void AsyncUDP::_recv(udp_pcb *upcb, pbuf *pb, const ip_addr_t *addr, uint16_t port, struct netif * netif)
{
  while (pb != NULL)
  {
    pbuf * this_pb = pb;
...
inline void AsyncUDP::_s_recv(void *arg, udp_pcb *upcb, pbuf *p, const ip_addr_t *addr, uint16_t port, struct netif * netif)
{
...
inline bool AsyncUDP::listen(uint16_t port)
{
...
inline bool AsyncUDP::listen(const IPAddress addr, uint16_t port)
{
  ip_addr_t laddr;
...
inline bool AsyncUDP::listenMulticast(const IPAddress addr, uint16_t port, uint8_t ttl, tcpip_adapter_if_t tcpip_if)
{
  ip_addr_t laddr;
  laddr.type = IPADDR_TYPE_V4;
  laddr.u_addr.ip4.addr = addr;
...
inline bool AsyncUDP::connect(const IPAddress addr, uint16_t port)
{
  ip_addr_t daddr;
...
inline size_t AsyncUDP::writeTo(const uint8_t *data, size_t len, const IPAddress addr, uint16_t port,
                         tcpip_adapter_if_t tcpip_if)
{
  ip_addr_t daddr;
  daddr.type = IPADDR_TYPE_V4;
...
inline IPAddress AsyncUDP::listenIP()
{
...
inline bool AsyncUDP::listen(const IPv6Address addr, uint16_t port)
{
  ip_addr_t laddr;
...
inline bool AsyncUDP::listenMulticast(const IPv6Address addr, uint16_t port, uint8_t ttl, tcpip_adapter_if_t tcpip_if)
{
  ip_addr_t laddr;
  laddr.type = IPADDR_TYPE_V6;
  memcpy((uint8_t*)(laddr.u_addr.ip6.addr), (const uint8_t*)addr, 16);
...
inline bool AsyncUDP::connect(const IPv6Address addr, uint16_t port)
{
  ip_addr_t daddr;
...
inline size_t AsyncUDP::writeTo(const uint8_t *data, size_t len, const IPv6Address addr, uint16_t port,
                         tcpip_adapter_if_t tcpip_if)
{
  ip_addr_t daddr;
  daddr.type = IPADDR_TYPE_V6;
...
inline IPv6Address AsyncUDP::listenIPv6()
{
...
inline size_t AsyncUDP::write(const uint8_t *data, size_t len)
{
...
inline size_t AsyncUDP::write(uint8_t data)
{
  return write(&data, 1);
}
...
inline size_t AsyncUDP::broadcastTo(uint8_t *data, size_t len, uint16_t port, tcpip_adapter_if_t tcpip_if)
{
...
inline size_t AsyncUDP::broadcastTo(const char * data, uint16_t port, tcpip_adapter_if_t tcpip_if)
{
...
inline size_t AsyncUDP::broadcast(uint8_t *data, size_t len)
{
...
inline size_t AsyncUDP::broadcast(const char * data)
{
...
inline size_t AsyncUDP::sendTo(AsyncUDPMessage &message, const ip_addr_t *addr, uint16_t port, tcpip_adapter_if_t tcpip_if)
{
  if (!message)
  {
    return 0;
...
inline size_t AsyncUDP::sendTo(AsyncUDPMessage &message, const IPAddress addr, uint16_t port, tcpip_adapter_if_t tcpip_if)
{
  if (!message)
  {
    return 0;
...
inline size_t AsyncUDP::sendTo(AsyncUDPMessage &message, const IPv6Address addr, uint16_t port, tcpip_adapter_if_t tcpip_if)
{
  if (!message)
  {
    return 0;
...
inline size_t AsyncUDP::send(AsyncUDPMessage &message)
{
  if (!message)
  {
    return 0;
...
inline size_t AsyncUDP::broadcastTo(AsyncUDPMessage &message, uint16_t port, tcpip_adapter_if_t tcpip_if)
{
  if (!message)
  {
    return 0;
...
inline size_t AsyncUDP::broadcast(AsyncUDPMessage &message)
{
  if (!message)
  {
    return 0;
...
inline bool AsyncUDP::connected()
{
  return _connected;
}
...
inline esp_err_t AsyncUDP::lastErr()
{
  return _lastErr;
}
...
inline void AsyncUDP::onPacket(AuPacketHandlerFunctionWithArg cb, void * arg)
{
...
inline void AsyncUDP::onPacket(AuPacketHandlerFunction cb)
{
  _handler = cb;
}
...
#endif    // ASYNC_UDP_ESP32_ETHERNET_IMPL_H
